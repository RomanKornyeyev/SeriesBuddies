...
{    
    ...
    protected $claseLabel; //clases del label
    ...
    public function __construct($null = self::NULL_NO, $valor = "", $name = "", $label = "",$claseLabel = array(""), $claseWrapper = array("input-wrapper"), $claseInput = array("input")) {
        $this->null = $null;
        $this->valor = $valor;
        $this->name = $name;
        $this->label = $label;
