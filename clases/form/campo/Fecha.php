...
class Fecha extends Atipo
{
    ...
    public function __construct($null, $valor, $name, $label, $claseLabel, $claseWrapper, $claseInput, $inicio = self::NOW, $fin = self::PLUS_ONE_WEEK){
    ...
    function pintar(){
        ...
        echo "<label for='$this->name' class='".implode(" ", $this->claseLabel)."'>$this->label (entre ".date("Y-m-d", $this->inicio)." y ".date("Y-m-d", $this->fin).")</label>\n";
        $this->imprimirError();
    }
}
