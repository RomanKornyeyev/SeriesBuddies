...
namespace clases\form\campo;

class Multiple extends Atipo
{
    private $claseLabelMultiple = array();
    ...
    public function __construct($null,$valor,$name,$label,$claseLabel,$claseWrapper,$claseInput,$claseLabelMultiple,$claseMultiple=array(""),$tipo=self::TYPE_CHECKBOX,$arr = []){
        parent::__construct($null,$valor,$name,$label,$claseLabel,$claseWrapper,$claseInput);
        $this->claseLabelMultiple = $claseLabelMultiple;
    ...
    public function pintar(){
        ...
        if ($this->tipo == "checkbox") {
            ...
            foreach ($this->arr as $value) {
                ...
                echo "<label class='".implode(" ", $this->claseLabelMultiple)."'>
        ...
        // --- si es radio --- 
            ...
            foreach ($this->arr as $value) {
                ...
                echo "<label for='$value' class='".implode(" ", $this->claseLabelMultiple)."'>$value</label><br>\n";
            }
            echo "</div>\n";
